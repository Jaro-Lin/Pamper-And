...
public class MyFansAdapter extends RecyclerView.Adapter<MyFansAdapter.ViewHolder> {
    ...
    private List<GetMyFansUtil> data;
    //是否关注，默认无关注
    private boolean isFollow=false;

    private CancelFocusOnDialog cancelFocusOnDialog;

    public UpdateFansData updateFansData;

    public void setUpdateFansData(UpdateFansData updateFansData) {
        this.updateFansData = updateFansData;
    }

    public interface UpdateFansData{
        void updateFans();
    }

    public MyFansAdapter(Context context, List<GetMyFansUtil>  data) {
    ...
    @NonNull
    @Override
    public MyFansAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new ViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_my_fans_item,viewGroup, false));
    }

    @Override
    public void onBindViewHolder(@NonNull MyFansAdapter.ViewHolder viewHolder, final int i) {
        ...
        if (data.get(i).getIsFocusOn().equals("1")){
            viewHolder.iv_collection.setImageResource(R.mipmap.follow_img);
        }else {
            viewHolder.iv_collection.setImageResource(R.mipmap.no_follow_img);
        }
...
//                }
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("uid",data.get(i).getId());
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        try {
                            ...
                            if (code== AppConfig.SUCCESS){
                               //操作成功，关注与取消关注
                                if(updateFansData!=null){
                                    updateFansData.updateFans();
