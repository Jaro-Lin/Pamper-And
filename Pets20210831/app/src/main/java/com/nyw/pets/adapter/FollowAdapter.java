...
public class FollowAdapter extends RecyclerView.Adapter<FollowAdapter.ViewHolder> {
    ...
    public FollowAdapter(Context context, List<FollowUtil>  data) {
    ...
    @NonNull
    @Override
    public FollowAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new ViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_follow_item,viewGroup, false));
    }

    @Override
    public void onBindViewHolder(@NonNull final FollowAdapter.ViewHolder viewHolder, final int i) {
...
//                ToastManager.showShortToast(context,"点击分享adapter");
        ...
        FollowUtil recyclerViewItem =data.get(i);
     ...
     * 点赞与取消点赞
     */
    private void sendThumbsAnd(FollowAdapter.ViewHolder viewHolder,int i,String url) {
     ...
     * @param url
     */
    private void sendCollection(FollowAdapter.ViewHolder viewHolder ,int i,String url) {
        SharedPreferences getUser=context.getSharedPreferences(SaveAPPData.USER_ID_Token,Context.MODE_PRIVATE);
        String token= getUser.getString(SaveAPPData.TOKEN,null);
        Log.i("sdjfsifsjfsf",token);
