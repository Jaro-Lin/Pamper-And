 ...
 * 
 */
public class CancelOrderInfoDialog {
	 ...
	 * @return
	 */
	public CancelOrderInfoDialog(Context con) {
		this.context = con;
		dialog = new Dialog(context, R.style.mydialog_style);
		dialog.setContentView(R.layout.cancel_order_info_dialog);
		//设置dialog以外的不能点击
