...
import com.nyw.pets.fragment.util.CollectionFragmentUtil;
...
//        mViewPager.setOffscreenPageLimit(0);
    ...
    public class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            mFragment.add(CollectionFragmentUtil.createFragment(position));
            return CollectionFragmentUtil.createFragment(position);
        }
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            ft.remove(fragment);
            //换成新的fragment
            fragment = CollectionFragmentUtil.createFragment(position);
