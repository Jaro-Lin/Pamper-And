...
public class ShopSearchAdapter extends RecyclerView.Adapter<ShopSearchAdapter.ViewHolder> {
    ...
    private List<ShopSearchDataUtil> data;

    public ShopSearchAdapter(Context context, List<ShopSearchDataUtil>  data) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ShopSearchAdapter.ViewHolder viewHolder, final int i) {
    ...
    private void addShopCartInfo(int i){
        ...
        String shop_id=data.get(i).getShopId();
        String spe_id=data.get(i).getSpe_id();

        Log.i("sdfsiofskfsffg",url+"  "+shop_id+"  "+spe_id);
